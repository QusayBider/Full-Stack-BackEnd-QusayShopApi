...
namespace QusayShopApi.DAL.Migrations
{
    ...
    [Migration("20251013061810_UploadFullCode")]
    partial class UploadFullCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QusayShopApi.DAL.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasOne("QusayShopApi.DAL.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("QusayShopApi.DAL.Models.Product.Product", b =>
                {
                    b.HasOne("QusayShopApi.DAL.Models.Brand.Brand", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("BrandId");

                    b.HasOne("QusayShopApi.DAL.Models.Category.Category", "Category")
                        .WithMany("Products")
